<template>
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <h2 style="width: 70%;float: left;">Pedidos Enviados </h2>
                </div>
                <div class="body">
                    <hr>
                    <br>
            ...
            <div class="modal-dialog"  style="max-width: 800px;" >
                <div class="modal-content">
                            ...
                            <div class="form-group row " style="margin: 0;">
                                ...
                                <div class="col-md-4" style="padding: 0 5%;">
                                    <div class="estado" id="div_estado">
                                        <i class="fa fa-circle" aria-hidden="true" style="color: #28AF55 !important;"> </i> Estado: <span><span
                                            data-ng-bind="vm.venta.state" class="ng-binding">Enviado</span></span>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer" style="text-align: center">
                        <!--<button type="submit" class="btn btn-success" v-on:click="entregarPedido(item_pedido)">
                            Pedido Entregado
                        </button>-->
...
<script>
    export default {
        ...
        methods: {
            listarPedidos() {
                axios.get(route('pedidos.get','ENVIADO')).then((response) => {
            ...
            entregarPedido(pedido){
                swal.fire({
                    ...
                    if (result.value) {
                        axios.get(route('pedido.entregado', pedido.id))
                            .then((response) => {
                                if (response.data) {
                                    this.listarPedidos();
                                    this.resetForm();
