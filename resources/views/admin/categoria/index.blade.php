...
@section('content')
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <h2 style="width: 70%;float: left;">Listado de Categorias </h2>

                    <a href="{{route('categoria.create')}}" class="btn btn-verde" style="float: right;">
                                ...
                                <tr>
                                    ...
                                    <!--<td>
                                        <div class="media-object">
                                            <img src="{{asset('images/categoria/'.$categoria->imagen)}}" alt=""
                                    ...
                                    <td>
                                        <div class="media-object">
                                            <img src="{{asset('images/categoriaweb/'.$categoria->imagen_web)}}" alt=""
                                                    width="65px" class="rounded-circle">
                                        </div>
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <a href="{{route('categoria.edit',$categoria->id)}}" class="btn btn-info"
                                           title="Editar">
