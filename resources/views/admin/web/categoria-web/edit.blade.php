        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    {!! Form::open(['route' => ['categoriaweb.update',$categoriaweb->id],'method'=>'PUT','files'=>true]) !!}
                    ...
                    <div class="form-group">
                        <div class="row clearfix">
                            <div class="col-md-6">
                                <label>Tipo</label>
                                {!! Form::select('tipo', ['CARTA'=>'CARTA','BAR'=>'BAR'],$categoriaweb->tipo, ['class' => 'form-control','id'=>'tipo','required']) !!}
                            </div>
                            <div class="col-md-6">
                                <label>Categoria</label>
                                {!! Form::text('nombre', $categoriaweb->nombre, ['class' => 'form-control','required']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" id="input-file-now-custom-3" class="dropify"
                                       ...
                                       data-default-file="{{ asset( 'images/categoriaweb/'.$categoriaweb->imagen ) }}"
                                       name="imagen"/>
                    ...
                    <a type="button" href="{{ route('categoriaweb.mostrar') }}" class="btn btn-secondary">Cancelar</a>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
