                ...
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class=" mb-20">
                                <img src="../img/empresa/que-significa-idi.jpg" alt=""/>
                                <!-- /work-slider -->
                            </div>
                            <div class="page-grid">
                                <!-- GRID 9 COLUMNS -->
                                <div class="page-content col-12">
                                    ...
                                    <p>Indagación original y planificada que persiga descubrir nuevos conocimientos y
                                        una
                                    ...
                                    <p>
                                        Es la Actividad cuyo resultado sea un nuevo invento o diseño, un nuevo proceso,
                                        nuevo sistema, etc., etc. para la obtención de
                                        un nuevo producto con las respectivas nuevas características en Tecnología, en
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_linklist">
                                <ul>
                                    <li>
                                        <a href="<?php echo SERVIDOR; ?>/empresa/que-es.php"
                                           class="btn btn-gray fullwidth text-left">Qué es Idi Mining &
                                            Industries S.A.C.</a>
                                    </li>
                                    <li class="active">
                                        <a href="<?php echo SERVIDOR; ?>/empresa/significa.php"
                                           class="btn btn-gray fullwidth text-left">Qué significa I+D+I</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo SERVIDOR; ?>/empresa/mision_vision.php"
                                           class="btn btn-gray fullwidth text-left">Nuestra Misión y Visión</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo SERVIDOR; ?>/empresa/estructura.php"
                                           class="btn btn-gray fullwidth text-left">Estructura Orgánica</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo SERVIDOR; ?>/empresa/sede.php"
                                           class="btn btn-gray fullwidth text-left">Nuestra Sede</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo SERVIDOR; ?>/empresa/logo.php"
                                           class="btn btn-gray fullwidth text-left">Nuestro Logo</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo SERVIDOR; ?>/empresa/lider.php"
                                           class="btn btn-gray fullwidth text-left">Palabras de Nuestro
                                            Líder</a>
                                    </li>
                                </ul>
