                ...
                <div class="col-md-12  col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class=" mb-20">
                                <img src="../../img/correcciones/Supergramp-seguro.jpg" alt=""/>
                            </div>
                            <!-- /work-slider -->
                            <div class="page-grid">
                                <!-- GRID 9 COLUMNS -->
                                ...
                                <div class="page-content col-12">
                                    <p>En la mayoría de las Operaciones mineras del tipo convencional se tenía una serie
                                        de problemas
                                        con las grampas de sujeción del sistema Trolley (conductor desnudo de cobre por
                                        donde recorre
                                        la energía DC a lo largo de la galería) y las consecuencias de estas fallas
                                        traían consigo una serie
                                        de riesgos y problemas permanentes, paradas de equipos, pérdidas de producción,
                                        etc., etc. En
                                        base a la actividad de I+D+I, se desarrolló un nuevo producto denominado
                                        Supergramp; el cual
                                        no permitía desengraparse fácilmente lo cual lo hacía más difícil la sustracción
                                        del trolley,
                                        asimismo en curvas cerradas este dispositivo se comportaba mejor el cual impedía
                                        la salida del
