...
<div id="page-wrap">
    ...
    <section class="section bg-white pt-70 pb-60  textura" style="padding: 20px !important;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a href="<?php echo SERVIDOR ?>/innovacion/nuevos.php" class="btn btn-black" style="float:right;">Regresar</a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div id="content" class="site-content">
                        <main id="main">
                            ...
                            <div class="page-grid">
                                ...
                                <p>
                                El calentamiento Global está haciendo daño a nuestra tierra y parte de ella a los vehículo que están
expuestos al SOL con altos grados de Temperatura y cualquier vehículo con artículos dentro como:
celulares, CD’s y con los mismos componentes del vehículo; pueden originar Daños en dichos objetos
mencionados y lo más grave, es que se tienen noticias que el incremento de la temperatura solar
está ocasionando incendios inesperados desde el interior del vehículo, por tal razón estamos
investigando como atenuar esta situación y protegerlos del Sol a cualquier tipo de vehículo que está
