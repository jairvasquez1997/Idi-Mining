            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3 col-sm-12 col-xs-12">
                    <div id="content" class="site-content">
                        <main id="main">
                            <h2 class="section-header">Escuela para Trabajar en Mina en el área de Mantenimiento Eléctrico</h2>
                            <div class=" mb-20">
                                <img src="../img/escuela/escuela-para-trabajar-en-mina-1.jpg" alt=""/>
                            </div>

                            <div class=" mb-20">
                                <img src="../img/escuela/escuela-para-trabajar-en-mina-2.jpg" alt=""/>
                            </div>
                        </main>
                    </div>
                </div>
