!function (a) {
    ...
    function g(a) {
        var b = Ua.defaults.oLanguage, c = a.sZeroRecords;
    ...
    function j(c) {
        if (!Ua.__browser) {
            ...
            var e = a("<div/>").css({
                    ...
                    width: 100,
                    overflow: "scroll"
                }).append(a("<div/>").css({width: "100%", height: 10}))).appendTo("body"), f = e.children(),
                g = f.children();
    ...
    function l(b, d) {
        var e = Ua.defaults.column, f = b.aoColumns.length, e = a.extend({}, Ua.models.oColumn, e, {
    ...
    function s(a) {
        var b, c, e, f, g, h, i, j, k, l = a.aoColumns, m = a.aoData, n = Ua.ext.type.detect;
        for (b = 0, c = l.length; b < c; b++) if (i = l[b], k = [], !i.sType && i._sManualType) i.sType = i._sManualType; else if (!i.sType) {
    ...
    function t(b, c, e, f) {
        ...
        if (c) for (g = c.length - 1; 0 <= g; g--) {
            ...
            for (a.isArray(o) || (o = [o]), h = 0, i = o.length; h < i; h++) if ("number" == typeof o[h] && 0 <= o[h]) {
                for (; n.length <= o[h];) l(b);
                f(o[h], m)
            } else if ("number" == typeof o[h] && 0 > o[h]) f(n.length + o[h], m); else if ("string" == typeof o[h]) for (j = 0, k = n.length; j < k; j++) ("_all" == o[h] || a(n[j].nTh).hasClass(o[h])) && f(j, m)
        }
        if (e) for (g = 0, b = e.length; g < b; g++) f(g, e[g])
    }

    function u(b, c, e, f) {
        var g = b.aoData.length, h = a.extend(!0, {}, Ua.models.oRow, {src: e ? "dom" : "data", idx: g});
    ...
    function w(a, b, c, e) {
        var f = a.iDraw, g = a.aoColumns[c], h = a.aoData[b]._aData, i = g.sDefaultContent,
            j = g.fnGetData(h, e, {settings: a, row: b, col: c});
                ...
                if ("" !== f) {
                    ...
                    for (var i = 0, j = h.length; i < j; i++) {
                        if (f = h[i].match(kb), g = h[i].match(lb), f) {
                            if (h[i] = h[i].replace(kb, ""), "" !== h[i] && (b = b[h[i]]), g = [], h.splice(0, i + 1), h = h.join("."), a.isArray(b)) for (i = 0, j = b.length; i < j; i++) g.push(e(b[i], c, h));
                            b = f[0].substring(1, f[0].length - 1), b = "" === b ? g : g.join(b);
                            break
                        }
                        if (g) h[i] = h[i].replace(lb, ""), b = b[h[i]](); else {
            ...
            var c = function (b, e, f) {
                ...
                for (var h, i, j = 0, k = f.length - 1; j < k; j++) {
                    if (h = f[j].match(kb), i = f[j].match(lb), h) {
                        if (f[j] = f[j].replace(kb, ""), b[f[j]] = [], g = f.slice(), g.splice(0, j + 1), h = g.join("."), a.isArray(e)) for (i = 0, k = e.length; i < k; i++) g = {}, c(g, e[i], h), b[f[j]].push(g); else b[f[j]] = e;
                        return
                    }
    ...
    function E(a, b, c, e) {
        ...
        if ("dom" !== c && (c && "auto" !== c || "dom" !== g.src)) {
            var i = g.anCells;
            if (i) if (e !== d) h(i[e], e); else for (c = 0, f = i.length; c < f; c++) h(i[c], c)
    ...
    function F(b, c, e, f) {
        ...
        if (k) for (; k;) g = k.nodeName.toUpperCase(), "TD" != g && "TH" != g || (p(k), j.push(k)), k = k.nextSibling; else for (j = c.anCells, k = 0, g = j.length; k < g; k++) p(j[k]);
        return (c = c.firstChild ? c : c.nTr) && (c = c.getAttribute("id")) && A(b.rowId)(f, c), {data: f, cells: j}
    }
    ...
    function I(b) {
        ...
        if (j && N(b.aoHeader, h), a(h).find(">tr").attr("role", "row"), a(h).find(">tr>th, >tr>td").addClass(k.sHeaderTH), a(i).find(">tr>th, >tr>td").addClass(k.sFooterTH), null !== i) for (b = b.aoFooter[0], c = 0, d = b.length; c < d; c++) g = l[c], g.nTf = b[c].cell, g.sClass && a(g.nTf).addClass(g.sClass)
    }

    function J(b, c, e) {
        var f, g, h, i, j = [], k = [], l = b.aoColumns.length;
        if (c) {
            ...
            for (f = 0, g = j.length; f < g; f++) {
                if (b = j[f].nTr) for (; h = b.firstChild;) b.removeChild(h);
                for (h = 0, c = j[f].length; h < c; h++) if (i = l = 1, k[f][h] === d) {
    ...
    function K(b) {
        ...
        if (-1 !== a.inArray(!1, c)) la(b, !1); else {
            var c = [], e = 0, f = b.asStripeClasses, g = f.length, h = b.oLanguage, i = b.iInitDisplayStart,
                j = "ssp" == Ma(b), k = b.aiDisplay;
            ...
            if (0 !== k.length) for (h = j ? b.aoData.length : l, j = j ? 0 : i; j < h; j++) {
            ...
            } else e = h.sZeroRecords, 1 == b.iDraw && "ajax" == Ma(b) ? e = h.sLoadingRecords : h.sEmptyTable && 0 === b.fnRecordsTotal() && (e = h.sEmptyTable), c[0] = a("<tr/>", {class: g ? f[0] : ""}).append(a("<td />", {
                valign: "top",
                colSpan: q(b),
    ...
    function M(b) {
        var c = b.oClasses, d = a(b.nTable), d = a("<div/>").insertBefore(d), e = b.oFeatures,
            f = a("<div/>", {id: b.sTableId + "_wrapper", class: c.sWrapper + (b.nTFoot ? "" : " " + c.sNoFooter)});
        ...
        for (var g, h, i, j, k, l, m = b.sDom.split(""), n = 0; n < m.length; n++) {
            if (g = null, "<" == (h = m[n])) {
                ...
                f.append(i), f = a(i)
            } else if (">" == h) f = f.parent(); else if ("l" == h && e.bPaginate && e.bLengthChange) g = ha(b); else if ("f" == h && e.bFilter) g = U(b); else if ("r" == h && e.bProcessing) g = ka(b); else if ("t" == h) g = ma(b); else if ("i" == h && e.bInfo) g = ba(b); else if ("p" == h && e.bPaginate) g = ia(b); else if (0 !== Ua.ext.feature.length) for (i = Ua.ext.feature, l = 0, j = i.length; l < j; l++) if (h == i[l].cFeature) {
                g = i[l].fnInit(b);
                break
            }
    ...
    function P(b, c, d) {
        ...
        if (a.isPlainObject(h) && h.data) {
            g = h.data;
            var k = a.isFunction(g) ? g(c, b) : g, c = a.isFunction(g) && k ? k : a.extend(!0, c, k);
            delete h.data
        }
        k = {
            data: c, success: function (a) {
                var c = a.error || a.sError;
                c && Ea(b, 0, c), b.json = a, j(a)
            }, dataType: "json", cache: !1, type: b.sServerMethod, error: function (c, d) {
                var e = Ja(b, null, "xhr", [b, null, b.jqXHR]);
                -1 === a.inArray(!0, e) && ("parsererror" == d ? Ea(b, 0, "Invalid JSON response", 1) : 4 === c.readyState && Ea(b, 0, "Ajax error", 7)), la(b, !1)
            }
        }, b.oAjaxData = c, Ja(b, null, "preXhr", [b, c]), b.fnServerData ? b.fnServerData.call(i, b.sAjaxSource, a.map(c, function (a, b) {
            return {name: b, value: a}
        }), j, b) : b.sAjaxSource || "string" == typeof h ? b.jqXHR = a.ajax(a.extend(k, {url: h || b.sAjaxSource})) : a.isFunction(h) ? b.jqXHR = h.call(i, c, j, b) : (b.jqXHR = a.ajax(a.extend(k, h)), h.data = g)
    }
    ...
    function R(b) {
        var c, d, e, f, g = b.aoColumns, h = g.length, i = b.oFeatures, j = b.oPreviousSearch, k = b.aoPreSearchCols,
            l = [], m = ua(b);
        ...
        return i.bFilter && (n("sSearch", j.sSearch), n("bRegex", j.bRegex)), i.bSort && (a.each(m, function (a, b) {
            o.order.push({column: b.col, dir: b.dir}), n("iSortCol_" + a, b.col), n("sSortDir_" + a, b.dir)
        }), n("iSortingCols", m.length)), g = Ua.ext.legacy.ajax, null === g ? b.sAjaxSource ? l : o : g ? l : o
    }

    function S(a, b) {
        var c = T(a, b), e = b.sEcho !== d ? b.sEcho : b.draw,
    ...
    function U(b) {
        var d = b.oClasses, e = b.sTableId, f = b.oLanguage, g = b.oPreviousSearch, h = b.aanFeatures,
            i = '<input type="search" class="' + d.sFilterInput + '"/>', j = f.sSearch,
            j = j.match(/_INPUT_/) ? j.replace("_INPUT_", i) : j + i,
            d = a("<div/>", {id: h.f ? null : e + "_filter", class: d.sFilter}).append(a("<label/>").append(j)),
            h = function () {
    ...
    function Y(a, b, c, d, e, f) {
        var g, d = Z(b, d, e, f), f = a.oPreviousSearch.sSearch, h = a.aiDisplayMaster, e = [];
        if (0 !== Ua.ext.search.length && (c = !0), g = $(a), 0 >= b.length) a.aiDisplay = h.slice(); else {
    ...
    function $(a) {
        var b, c, d, e, f, g, h, i, j = a.aoColumns, k = Ua.ext.type.search;
        for (b = !1, c = 0, e = a.aoData.length; c < e; c++) if (i = a.aoData[c], !i._aFilterData) {
    ...
    function ca(b) {
        ...
        if (0 !== c.length) {
            var d = b.oLanguage, e = b._iDisplayStart + 1, f = b.fnDisplayEnd(), g = b.fnRecordsTotal(),
                h = b.fnRecordsDisplay(), i = h ? d.sInfo : d.sInfoEmpty;
    ...
    function ea(a) {
        var b, c, d, e = a.iInitDisplayStart, f = a.aoColumns;
        c = a.oFeatures;
    ...
    function ia(b) {
        var c = b.sPaginationType, d = Ua.ext.pager[c], e = "function" == typeof d, f = function (a) {
            K(a)
        ...
        return e || d.fnInit(b, c, f), g.p || (c.id = b.sTableId + "_paginate", b.aoDrawCallback.push({
            fn: function (a) {
                if (e) {
                    var b, c = a._iDisplayStart, h = a._iDisplayLength, i = a.fnRecordsDisplay(), j = -1 === h,
                        c = j ? 0 : Math.ceil(c / h), h = j ? 1 : Math.ceil(i / h), i = d(c, h), j = 0;
    ...
    function ma(b) {
        ...
        var e = d.sX, f = d.sY, g = b.oClasses, h = c.children("caption"), i = h.length ? h[0]._captionSide : null,
            j = a(c[0].cloneNode(!1)), k = a(c[0].cloneNode(!1)), l = c.children("tfoot");
        l.length || (l = null), j = a("<div/>", {class: g.sScrollWrapper}).append(a("<div/>", {class: g.sScrollHead}).css({
            overflow: "hidden",
            position: "relative",
            border: 0,
            width: e ? e ? ta(e) : null : "100%"
        }).append(a("<div/>", {class: g.sScrollHeadInner}).css({
            "box-sizing": "content-box",
            width: d.sXInner || "100%"
        }).append(j.removeAttr("id").css("margin-left", 0).append("top" === i ? h : null).append(c.children("thead"))))).append(a("<div/>", {class: g.sScrollBody}).css({
            position: "relative",
            overflow: "auto",
            width: e ? ta(e) : null
        }).append(c)), l && j.append(a("<div/>", {class: g.sScrollFoot}).css({
            overflow: "hidden",
            border: 0,
            width: e ? e ? ta(e) : null : "100%"
        }).append(a("<div/>", {class: g.sScrollFootInner}).append(k.removeAttr("id").css("margin-left", 0).append("bottom" === i ? h : null).append(c.children("tfoot")))));
    ...
    function na(b) {
        var c, e, f, g, h, i = b.oScroll, j = i.sX, k = i.sXInner, l = i.sY, i = i.iBarWidth, m = a(b.nScrollHead),
            p = m[0].style, q = m.children("div"), r = q[0].style, s = q.children("table"), q = b.nScrollBody, t = a(q),
            u = q.style, v = a(b.nScrollFoot).children("div"), w = v.children("table"), x = a(b.nTHead),
            y = a(b.nTable), z = y[0], A = z.style, B = b.nTFoot ? a(b.nTFoot) : null, C = b.oBrowser,
            D = C.bScrollOversize, E = eb(b.aoColumns, "nTh"), F = [], G = [], H = [], I = [], J = function (a) {
    ...
    function pa(c) {
        var d, e, f = c.nTable, g = c.aoColumns, h = c.oScroll, i = h.sY, j = h.sX, k = h.sXInner, l = g.length,
            m = r(c, "bVisible"), p = a("th", c.nTHead), s = f.getAttribute("width"), t = f.parentNode, u = !1,
            v = c.oBrowser, h = v.bScrollOversize;
        for ((d = f.style.width) && -1 !== d.indexOf("%") && (s = d), d = 0; d < m.length; d++) e = g[m[d]], null !== e.sWidth && (e.sWidth = qa(e.sWidthOrig, t), u = !0);
        if (h || !u && !j && !i && l == q(c) && l == p.length) for (d = 0; d < l; d++) null !== (m = o(c, d)) && (g[m].sWidth = ta(p.eq(d).width())); else {
            ...
            if (c.aoData.length) for (d = 0; d < m.length; d++) u = m[d], e = g[u], a(ra(c, u)).clone(!1).append(e.sContentPadding).appendTo(w);
    ...
    function qa(b, d) {
        if (!b) return 0;
        var e = a("<div/>").css("width", ta(b)).appendTo(d || c.body), f = e[0].offsetWidth;
        return e.remove(), f
    }
    ...
    function ua(b) {
        var c, e, f, g, h, i, j = [], k = b.aoColumns;
        c = b.aaSortingFixed, e = a.isPlainObject(c);
        var l = [];
        for (f = function (b) {
            b.length && !a.isArray(b[0]) ? l.push(b) : a.merge(l, b)
        }, a.isArray(c) && f(c), e && c.pre && f(c.pre), f(b.aaSorting), e && c.post && f(c.post), b = 0; b < l.length; b++) for (i = l[b][0], f = k[i].aDataSort, c = 0, e = f.length; c < e; c++) g = f[c], h = k[g].sType || "string", l[b]._idx === d && (l[b]._idx = a.inArray(l[b][1], k[g].asSorting)), j.push({
            src: i,
            col: g,
            dir: l[b][1],
            index: l[b]._idx,
    ...
    function va(a) {
        ...
        if ("ssp" != Ma(a) && 0 !== e.length) {
            ...
            i === e.length ? j.sort(function (a, b) {
                ...
                for (g = 0; g < j; g++) if (i = e[g], c = k[i.col], d = l[i.col], 0 !== (c = c < d ? -1 : c > d ? 1 : 0)) return "asc" === i.dir ? c : -c;
                return c = f[a], d = f[b], c < d ? -1 : c > d ? 1 : 0
            }) : j.sort(function (a, b) {
                var c, d, i, j, k = e.length, l = h[a]._aSortData, m = h[b]._aSortData;
                for (i = 0; i < k; i++) if (j = e[i], c = l[j.col], d = m[j.col], j = g[j.type + "-" + j.dir] || g["string-" + j.dir], 0 !== (c = j(c, d))) return c;
                return c = f[a], d = f[b], c < d ? -1 : c > d ? 1 : 0
            })
        }
        a.bSorted = !0
    ...
    function za(b) {
        var c, d, e = b.aLastSort, f = b.oClasses.sSortColumn, g = ua(b), h = b.oFeatures;
    ...
    function Aa(a, b) {
        var c, d = a.aoColumns[b], e = Ua.ext.order[d.sSortDataType];
        ...
        if (b.oFeatures.bStateSave && !b.bDestroying) {
            var c = {
                ...
                columns: a.map(b.aoColumns, function (a, c) {
                    return {visible: a.bVisible, search: _(b.aoPreSearchCols[c])}
                })
            };
        ...
        var f, g, h = b.aoColumns, c = function (c) {
            if (c && c.time) {
                ...
                if (-1 === a.inArray(!1, i) && !(0 < (i = b.iStateDuration) && c.time < +new Date - 1e3 * i || c.columns && h.length !== c.columns.length)) {
                    ...
                    })), c.search !== d && a.extend(b.oPreviousSearch, aa(c.search)), c.columns) for (f = 0, g = c.columns.length; f < g; f++) i = c.columns[f], i.visible !== d && (h[f].bVisible = i.visible), i.search !== d && a.extend(b.aoPreSearchCols[f], aa(i.search));
    ...
    function Da(b) {
        var c = Ua.settings, b = a.inArray(b, eb(c, "nTable"));
        return -1 !== b ? c[b] : null
    }

    function Ea(a, c, d, e) {
        if (d = "DataTables warning: " + (a ? "table id=" + a.sTableId + " - " : "") + d, e && (d += ". For more information about this error, please see http://datatables.net/tn/" + e), c) b.console && console.log && console.log(d); else if (c = Ua.ext, c = c.sErrMode || c.errMode, a && Ja(a, null, "error", [a, e, d]), "alert" == c) alert(d); else {
    ...
    function La(b, c) {
        var d = b.renderer, e = Ua.ext.renderer[c];
    ...
    function Na(a, b) {
        var c = [], c = Db.numbers_length, d = Math.floor(c / 2);
    ...
    var Qa, Ra, Sa, Ta, Ua = function (b) {
            ...
            return this.each(function () {
                var n, o = {}, p = 1 < k ? Ga(o, b, !0) : b, q = 0, o = this.getAttribute("id"), r = !1, s = Ua.defaults,
                    w = a(this);
                if ("table" != this.nodeName.toLowerCase()) Ea(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    var o = B.asStripeClasses, E = w.children("tbody").find("tr").eq(0);
                    if (-1 !== a.inArray(!0, a.map(o, function (a) {
                        return E.hasClass(a)
                    })) && (a("tbody tr", this).removeClass(o.join(" ")), B.asDestroyStripes = o.slice()), o = [], x = this.getElementsByTagName("thead"), 0 !== x.length && (N(B.aoHeader, x[0]), o = O(B)), null === p.aoColumns) for (x = [], q = 0, n = o.length; q < n; q++) x.push(null); else x = p.aoColumns;
    ...
    var jb = function (a, b, c) {
            a[b] !== d && (a[c] = a[b])
        }, kb = /\[.*?\]$/, lb = /\(\)$/, mb = Ua.util.escapeRegex, nb = a("<div>")[0], ob = nb.textContent !== d,
        pb = /<.*?>/g, qb = Ua.util.throttle, rb = [], sb = Array.prototype, tb = function (b) {
            var c, d, e = Ua.settings, f = a.map(e, function (a) {
                return a.nTable
            });
    ...
    Ra = function (b, c) {
        ...
        any: function () {
            return 0 !== this.count()
        }, concat: sb.concat, context: [], count: function () {
            ...
            var b = [];
            if (sb.filter) b = sb.filter.call(this, a, this); else for (var c = 0, d = this.length; c < d; c++) a.call(this, this[c], c, this) && b.push(this[c]);
            return new Ra(this.context, b)
        }, flatten: function () {
            var a = [];
            return new Ra(this.context, a.concat.apply(a, this.toArray()))
        }, join: sb.join, indexOf: sb.indexOf || function (a, b) {
            ...
            for ("string" == typeof a && (e = c, c = b, b = a, a = !1), g = 0, h = n.length; g < h; g++) {
                var p = new Ra(n[g]);
                if ("table" === b) (f = c.call(p, n[g], g)) !== d && m.push(f); else if ("columns" === b || "rows" === b) (f = c.call(p, n[g], this[g], g)) !== d && m.push(f); else if ("column" === b || "column-rows" === b || "row" === b || "cell" === b) for (l = this[g], "column-rows" === b && (k = yb(n[g], o.opts)), i = 0, j = l.length; i < j; i++) f = l[i], (f = "cell" === b ? c.call(p, n[g], f.row, f.column, g, i) : c.call(p, n[g], f, g, i, k)) !== d && m.push(f)
            }
            ...
            var b = [];
            if (sb.map) b = sb.map.call(this, a, this); else for (var c = 0, d = this.length; c < d; c++) b.push(a.call(this, this[c], c));
            return new Ra(this.context, b)
        }, pluck: function (a) {
            return this.map(function (b) {
                return b[a]
            })
        }, pop: sb.pop, push: sb.push, reduce: sb.reduce || function (a, b) {
            return k(this, a, b, 0, this.length, 1)
        }, reduceRight: sb.reduceRight || function (a, b) {
            return k(this, a, b, this.length - 1, -1, -1)
        }, reverse: sb.reverse, selector: null, shift: sb.shift, slice: function () {
            return new Ra(this.context, this)
        }, sort: sb.sort, splice: sb.splice, toArray: function () {
        ...
        if (a.isArray(b)) for (var d = 0, e = b.length; d < e; d++) Ra.register(b[d], c); else for (var f, g, h = b.split("."), i = rb, d = 0, e = h.length; d < e; d++) {
            f = (g = -1 !== h[d].indexOf("()")) ? h[d].replace("()", "") : h[d];
            var j;
            a:{
                j = 0;
                for (var k = i.length; j < k; j++) if (i[j].name === f) {
                    j = i[j];
                    break a
                }
                j = null
    ...
    var vb = function (b, c, e, f, g) {
        var h, i, j, k, l, m, n = [];
        for (j = typeof c, c && "string" !== j && "function" !== j && c.length !== d || (c = [c]), j = 0, k = c.length; j < k; j++) for (i = c[j] && c[j].split && !c[j].match(/[\[\(:]/) ? c[j].split(",") : [c[j]], l = 0, m = i.length; l < m; l++) (h = e("string" == typeof i[l] ? a.trim(i[l]) : i[l])) && h.length && (n = n.concat(h));
        if (b = Qa.selector[b], b.length) for (j = 0, k = b.length; j < k; j++) n = b[j](f, g, n);
        return ib(n)
    }, wb = function (b) {
        ...
        if ("current" == f) for (d = b._iDisplayStart, e = b.fnDisplayEnd(); d < e; d++) g.push(h[d]); else if ("current" == e || "applied" == e) g = "none" == i ? d.slice() : "applied" == i ? h.slice() : a.map(d, function (b) {
            return -1 === a.inArray(b, h) ? b : null
        }); else if ("index" == e || "original" == e) for (d = 0, e = b.aoData.length; d < e; d++) "none" == i ? g.push(d) : (-1 === (f = a.inArray(d, h)) && "removed" == i || 0 <= f && "applied" == i) && g.push(d);
        return g
    };
    Sa("rows()", function (b, c) {
        b === d ? b = "" : a.isPlainObject(b) && (c = b, b = "");
        var c = wb(c), e = this.iterator("table", function (e) {
            var f, g = c;
        ...
        return this.iterator("row", function (b, c, e) {
            var f, g, h, i, j, k = b.aoData, l = k[c];
            for (k.splice(c, 1), f = 0, g = k.length; f < g; f++) if (h = k[f], j = h.anCells, null !== h.nTr && (h.nTr._DT_RowIndex = f), null !== j) for (h = 0, i = j.length; h < i; h++) j[h]._DT_CellIndex.row = f;
    ...
    var zb = function (a, b) {
        ...
        if (c.length && a.length) {
            ...
            if (d._details) {
                ...
                var e = c[0], f = new Ra(e), g = e.aoData;
                f.off("draw.dt.DT_details column-visibility.dt.DT_details destroy.dt.DT_details"), 0 < eb(g, "_details").length && (f.on("draw.dt.DT_details", function (a, b) {
                    ...
                    if (e === b) for (var c = 0, d = g.length; c < d; c++) g[c]._details && zb(f, c)
                }))
            }
        }
    };
    Sa("row().child()", function (b, c) {
        ...
        if (!0 === b) this.child.show(); else if (!1 === b) zb(this); else if (e.length && this.length) {
            var f = e[0], e = e[0].aoData[this[0]], g = [], h = function (b, c) {
                if (a.isArray(b) || b instanceof a) for (var d = 0, e = b.length; d < e; d++) h(b[d], c); else b.nodeName && "tr" === b.nodeName.toLowerCase() ? g.push(b) : (d = a("<tr><td/></tr>").addClass(c), a("td", d).addClass(c).html(b)[0].colSpan = q(f), g.push(d[0]))
            };
    ...
    var Bb = /^([^:]+):(name|visIdx|visible)$/, Cb = function (a, b, c, d, e) {
        for (var c = [], d = 0, f = e.length; d < f; d++) c.push(w(a, e[d], b));
        return c
    };
    Sa("columns()", function (b, c) {
        b === d ? b = "" : a.isPlainObject(b) && (c = b, b = "");
        var c = wb(c), e = this.iterator("table", function (d) {
            var e = b, f = c, g = d.aoColumns, h = eb(g, "sName"), i = eb(g, "nTh");
        ...
        var e = this.iterator("column", function (c, e) {
            ...
            var f, g, h, i = c.aoColumns, j = i[e], k = c.aoData;
            if (b !== d && j.bVisible !== b) {
                if (b) {
        ...
        if (a.isPlainObject(b) && (b.row === d ? (e = b, b = null) : (e = c, c = null)), a.isPlainObject(c) && (e = c, c = null), null === c || c === d) return this.iterator("table", function (c) {
            var f, g, h, i, j, k, l, m = b, n = wb(e), o = c.aoData, p = yb(c, n), q = hb(fb(o, p, "anCells")),
                r = a([].concat.apply([], q)), s = c.aoColumns.length;
            return vb("cell", m, function (b) {
                var e = "function" == typeof b;
                if (null === b || b === d || e) {
                    for (g = [], h = 0, i = p.length; h < i; h++) for (f = p[h], j = 0; j < s; j++) k = {
                        row: f,
                        column: j
        ...
        return a.extend(m.selector, {cols: c, rows: b, opts: e}), m
        ...
        for (var b, c, d = Ua.version.split("."), a = a.split("."), e = 0, f = a.length; e < f; e++) if (b = parseInt(d[e], 10) || 0, c = parseInt(a[e], 10) || 0, b !== c) return b > c;
        return !0
        ...
        return c = c || !1, this.iterator("table", function (d) {
            var e, f = d.nTableWrapper.parentNode, g = d.oClasses, h = d.nTable, i = d.nTBody, j = d.nTHead,
                k = d.nTFoot, l = a(h), i = a(i), m = a(d.nTableWrapper), n = a.map(d.aoData, function (a) {
                    return a.nTr
                });
    ...
    a.extend(Db, {
        ...
        }, _numbers: Na, numbers_length: 7
    }), a.extend(!0, Ua.ext.renderer, {
        pageButton: {
            _: function (b, e, f, g, h, i) {
                var j, k, l, m = b.oClasses, n = b.oLanguage.oPaginate, o = b.oLanguage.oAria.paginate || {}, p = 0,
                    q = function (c, d) {
                        var e, g, l, r, s = function (a) {
                            ja(b, a.data.action, !0)
                        };
                        for (e = 0, g = d.length; e < g; e++) if (r = d[e], a.isArray(r)) l = a("<" + (r.DT_el || "div") + "/>").appendTo(c), q(l, r); else {
                            switch (j = null, k = "", r) {
                                case"ellipsis":
                            ...
                            }).html(j).appendTo(c), Ha(l, {action: r}, s), p++)
                        }
                    };
                try {
    ...
    return a.extend(!0, e.defaults, {
        ...
        var k, l, m, n = new e.Api(b), o = b.oClasses, p = b.oLanguage.oPaginate, q = b.oLanguage.oAria.paginate || {},
            r = 0, s = function (c, d) {
                ...
                for (e = 0, f = d.length; e < f; e++) if (m = d[e], a.isArray(m)) s(c, m); else {
                    switch (l = k = "", m) {
                        case"ellipsis":
                            k = "&#x2026;", l = "disabled";
                            break;
                    ...
                    k && (h = a("<li>", {
                        ...
                        tabindex: b.iTabIndex,
                        class: "page-link"
                    }).html(k)).appendTo(c), b.oApi._fnBindAction(h, {action: m}, t), r++)
                }
            };
        try {
